...
public class LPageMaker {
	...
	private LCriteria lCri;

	public LCriteria getlCri() {
		return lCri;
	}

	public void setlCri(LCriteria lCri) {
		this.lCri = lCri;
	}
	...
	public void calcData() {
		int page = this.lCri.getPage();
		int perPageNum = this.lCri.getPerPageNum();
	...
	public String makeQuery(int page) {
		UriComponents uriComponents = UriComponentsBuilder.newInstance()
				...
				.queryParam("perPageNum", this.lCri.getPerPageNum())
				.build()
				.encode();
